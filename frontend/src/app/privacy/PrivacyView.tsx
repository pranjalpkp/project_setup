      ...
      <div className="pt-36 pb-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="space-y-8 text-slate-300 text-sm leading-relaxed text-left">
          ...
          <section className="space-y-3">
            ...
            <p>
              This Privacy Policy details how we collect, process, store, and safeguard your personal data when you visit <strong className="text-white">inkurban.in</strong>, request a technical/growth audit, schedule a strategy briefing, or engage our custom software development, growth marketing, and AI/ML engineering practice.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>We only collect data necessary to provide high-tier engineering, growth, and AI services:</p>
            <ul className="list-disc pl-6 space-y-2 text-slate-300">
              <li><strong className="text-white">Contact & Intake Details:</strong> Name, work email address, phone number, company/domain URL, project focus area, and preliminary technical requirements submitted via diagnostic request drawers or scheduling forms.</li>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-300">
              <li>Delivering complimentary 15-point video technical, growth, and AI audits.</li>
              <li>Scheduling and conducting 1-on-1 executive strategy briefings via Google Meet or Zoom.</li>
              <li>Architecting bespoke software applications, high-converting growth funnels, and autonomous AI automation pipelines.</li>
