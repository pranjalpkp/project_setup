    ...
    <main className="min-h-screen bg-[#07080C] text-slate-100 relative overflow-hidden font-sans selection:bg-rose-500/20 selection:text-white">
      ...
      <div className="pt-36 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-6">
        ...
        <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight max-w-4xl mx-auto">
          Proven Engineering. <span className="brand-gradient-text">Measurable Growth & AI Scaling.</span>
        </h1>

        <p className="text-slate-400 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed">
          Explore in-depth technical breakdowns of how Ink Urban architects custom software and SaaS platforms, builds high-converting growth funnels, and deploys autonomous AI & ML pipelines for ventures worldwide.
        </p>
        ...
        <div className="mt-8 p-4 rounded-2xl bg-[#0E1220] border border-amber-500/30 flex items-center space-x-3 text-xs text-amber-200/90 max-w-2xl mx-auto text-left shadow-lg">
          ...
          <span>
            <strong>Transparency Notice:</strong> All metrics represent verified empirical client outcomes, conversion telemetry, and sub-300ms Core Web Vitals benchmarks.
          </span>
        </div>
      </div>
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-800/80">
                <Link
                  ...
                  className="w-full py-3 rounded-xl brand-gradient-bg text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center space-x-2 shadow-lg shadow-rose-500/25 group-hover:scale-[1.02] min-h-[44px]"
                >
