        ...
        <div className="space-y-8 text-slate-300 text-sm leading-relaxed text-left">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white flex items-center space-x-2">
              <span className="text-rose-400">1.</span> <span>Zero-Trust Modular Architecture</span>
            </h2>
            <p>
              Traditional CMS platforms account for over 90% of web application security breaches worldwide due to vulnerable third-party plugins, outdated PHP runtimes, and exposed database admin paths.
            </p>
            <div className="p-4 rounded-xl bg-rose-500/10 border border-rose-500/30 text-xs text-slate-200 space-y-2">
              <div className="font-bold text-rose-400 flex items-center space-x-1.5">
                <ShieldCheckIcon className="w-4 h-4" />
                <span>Modern Serverless & Sandboxed Security Standard</span>
              </div>
              <p className="text-slate-300">
                Ink Urban architects custom software platforms using pre-compiled serverless rendering, hardened Spring Boot microservices, and sandboxed AI inference environments. Because there is no exposed CMS admin panel or vulnerable third-party plugins, client applications are inherently immune to standard database injection and brute-force exploits.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-white flex items-center space-x-2">
              <span className="text-rose-400">3.</span> <span>Data Confidentiality & Enterprise AI Sandboxing</span>
            </h2>
            <p>
              All technical audit teardowns, preliminary intake forms, and strategic client briefs are stored in encrypted environments. For AI & machine learning deployments, client data is strictly segregated in dedicated VPCs and never utilized for general foundational model re-training without explicit authorization. We routinely execute Non-Disclosure Agreements (NDAs) prior to project commencement.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              For security compliance questions or infrastructure disclosures, contact Ink Urban LLP technical directors at <a href="mailto:inkurban.in@gmail.com" className="text-rose-400 hover:text-rose-300 underline font-semibold">inkurban.in@gmail.com</a>.
            </p>
          </section>
