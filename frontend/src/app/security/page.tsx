        ...
        <div className="space-y-8 text-slate-700 text-sm leading-relaxed text-left">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 flex items-center space-x-2">
              <span className="text-rose-600">1.</span> <span>Zero WordPress Vulnerability Architecture</span>
            </h2>
            <p>
            ...
            <div className="p-4 rounded-xl bg-rose-50 border border-rose-200 text-xs text-slate-800 space-y-2">
              <div className="font-bold text-rose-700 flex items-center space-x-1.5">
                <ShieldCheckIcon className="w-4 h-4" />
                <span>Modern Jamstack & Serverless Security Standard</span>
              </div>
              <p className="text-slate-700">
                Ink Urban architects custom web platforms using pre-compiled serverless rendering and static page generation. Because there is no exposed SQL database or WordPress admin dashboard for hackers to target, client sites are inherently immune to standard database injection and brute-force plugin exploits.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 flex items-center space-x-2">
              <span className="text-rose-600">2.</span> <span>Global Edge Infrastructure & Encryption</span>
            </h2>
            <p>We deploy client web applications on enterprise global CDN edge networks equipped with:</p>
            <ul className="list-disc pl-6 space-y-2 text-slate-700">
              <li><strong className="text-slate-900">TLS 1.3 & SSL Encryption:</strong> 256-bit automated SSL certificates enforcing end-to-end HTTPS communication worldwide.</li>
              <li><strong className="text-slate-900">DDoS & Layer 7 Protection:</strong> Automated edge mitigation against Distributed Denial-of-Service attacks and malicious bot traffic.</li>
              <li><strong className="text-slate-900">Global Edge Node CDN:</strong> Sub-second global asset delivery with automated failover and 99.99% infrastructure uptime SLAs.</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 flex items-center space-x-2">
              <span className="text-rose-600">3.</span> <span>Data Confidentiality & Consultation Security</span>
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 flex items-center space-x-2">
              <span className="text-rose-600">4.</span> <span>Security Inquiries</span>
            </h2>
            <p>
              For security compliance questions or infrastructure disclosures, contact Ink Urban LLP technical directors at <a href="mailto:inkurban.in@gmail.com" className="text-rose-600 hover:text-rose-700 underline font-semibold">inkurban.in@gmail.com</a>.
            </p>
          </section>
