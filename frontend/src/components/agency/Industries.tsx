...
export const Industries: React.FC<IndustriesProps> = ({ onOpenBookingModal }) => {
  ...
  const niches = [
    {
      ...
      targetLocs: "NYC, Miami, Los Angeles, London, Dubai, Sydney",
    ...
    },
    {
      ...
      targetLocs: "Chicago, Toronto, Melbourne, London, Dubai",
    ...
    },
    {
      ...
      targetLocs: "New York, London, Vancouver, Sydney, Dubai DIFC",
    ...
    },
    {
      ...
      targetLocs: "Dallas, Phoenix, Houston, Toronto, Brisbane",
    ...
    },
    {
      ...
      targetLocs: "US, UK, UAE, Canada & Australia",
  ...
  return (
    <section id="industries" className="py-12 sm:py-16 bg-[#07080C] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 p-8 sm:p-10 rounded-2xl glass-panel-brand space-y-8 border border-rose-500/30 shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {current.outcomes.map((outcome, oIdx) => (
                <div key={oIdx} className="p-4 rounded-xl bg-[#0D111E] border border-amber-500/20 flex items-start space-x-3">
