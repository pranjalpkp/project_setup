...
export const FAQ: React.FC = () => {
  ...
  const faqs = [
    {
      question: "How does working with Ink Urban compare to hiring a local US/UK agency?",
      answer: "Local agencies in New York, London, or Sydney routinely charge $25,000 to $50,000+ for custom web builds due to expensive physical office overhead. Ink Urban delivers tier-1 international web architecture, sub-second speed, and conversion copywriting at a fraction of Western agency retainers — with zero compromise on quality or time-zone communication."
    },
    {
      question: "Why do you build custom websites (Next.js/React) instead of WordPress templates?",
      answer: "WordPress templates are heavily bloated with plugins, slow to load (costing you 50%+ of mobile visitors), and vulnerable to security hacks. Custom Next.js code loads in under 0.8 seconds worldwide, achieves 100/100 Core Web Vitals, and provides total flexibility for high-converting booking drawers and funnels."
    },
    {
  ...
  return (
    <section id="faq" className="py-12 sm:py-16 bg-[#07080C] relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <div
                ...
                className={`rounded-2xl transition-all duration-200 border ${
                  isOpen
                    ? 'bg-[#0F1322] border-amber-400/50 shadow-xl'
                    : 'bg-[#090C16] border-slate-800 hover:border-amber-400/40'
                }`}
              >
                <button
                  type="button"
                ...
                {isOpen && (
                  <div
                    id={answerId}
                    className="px-6 pb-6 text-sm text-slate-200 leading-relaxed border-t border-slate-800/80 pt-4"
                  >
                    {faq.answer}
                  </div>
                )}
        ...
        <div className="mt-12 text-center text-xs text-slate-300">
          ...
          <a href="mailto:inkurban.in@gmail.com" className="text-amber-300 hover:text-white font-semibold underline transition-colors">
