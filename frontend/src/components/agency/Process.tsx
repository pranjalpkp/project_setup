...
export const Process: React.FC<ProcessProps> = ({ onOpenBookingModal }) => {
  ...
  return (
    <section id="process" className="py-12 sm:py-16 bg-slate-50 border-t border-slate-200 relative">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="p-6 rounded-2xl glass-panel border border-slate-200 hover:border-amber-400 transition-all duration-300 space-y-5 flex flex-col justify-between group shadow-sm"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[11px] font-semibold text-slate-700 px-2.5 py-1 rounded bg-slate-100 border border-slate-200">
                      ⏱ {step.duration}
                    </span>
                  </div>
